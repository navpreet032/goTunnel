...
type ServerConfig struct {
	...
	// Domain is the public server address (domain or IP:port) for tunnel URLs (optional)
	// Example: "tunnel.example.com" or "easysource-mortalengine.hirequotient.com"
	// If not set, uses "localhost:PORT" in generated URLs
	Domain string
...
func LoadServerConfig() *ServerConfig {
	...
	domain := flag.String("domain", getEnv("TUNNEL_DOMAIN", ""), "Public server address (domain or IP:port) for tunnel URLs, e.g. 'tunnel.example.com' (env: TUNNEL_DOMAIN)")
